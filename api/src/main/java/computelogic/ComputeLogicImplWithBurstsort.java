...
public class ComputeLogicImplWithBurstsort implements ComputeLogic {

    private static final Logger logger = Logger.getLogger(ComputeLogicImplWithBurstsort.class);
